...
function ChompAI(difficulty, rows, cols) {
...
Object.assign(ChompAI.prototype, {

    constructor: ChompAI,

    findBestMove: function(grid) {
        ...
        if(strat[0] === 0 && strat[1] === 0) {
            return this.avoidBadMove(sumRows, sumCols);
        }
    ...
    findStrategy: function(sumRows, sumCols) {
    ...
    avoidBadMove: function(sumRows, sumCols) {
